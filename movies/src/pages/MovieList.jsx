      ...
      <main className="container">
        {title == "Your Guide to Great Movies" ? (
          <div className="bg-body-tertiary p-5 border mb-5">
            <h3 className="text-primary">Welocome to MovieHunt</h3>
            <p className="lead">MovieHunt is your ultimate guide to discovering movies, with curated lists of top-rated, popular, and upcoming films.</p>
